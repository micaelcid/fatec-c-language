...
2 ****- Escreva um programa com a estrutura abaixo. Defina um vetor de estruturas 
    de 4 elementos. Receba os dados pelo teclado e imprima-os no video. Fa\E7a um
...
3 - Crie uma estrutura para representar as coordenadas de um ponto no plano 
    ...
    distancia dele ate' a origem das coordenadas, isto \E9, posi\E7\E3o (0, 0). Para
    realizar o c\E1lculo, utilize a f\F3rmula a seguir:
           d = raiz quadrada de  (XB - XA)ao 2 +(YB -YA)ao 2
    Em que:
    d = dist\E2ncia entre os pontos A e B
